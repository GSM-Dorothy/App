...
school.get('/remain/administrator/:year/:month', validateTokenMiddleware, schoolCtrl.getRemainAdministratorByDate)
...
school.get('/remain/enroll/:year/:month', validateTokenMiddleware, schoolCtrl.findRemainEnroll)
school.get('/remain/enroll/:year/:month/:day', validateTokenMiddleware, schoolCtrl.findRemainEnroll)
...
school.get('/remain/archive/:year/:month', validateTokenMiddleware, schoolCtrl.findRemainArchive)
school.get('/remain/archive/:year/:month/:day', validateTokenMiddleware, schoolCtrl.findRemainArchive)
